    ...
    constructor(id) {
       ...
       start () {
        ...
        generateBubbles () {
            ...
            this.bubblesList.forEach((value) => {
                 value.move();
                 this.ctx.translate(value.translateX, value.translateY) // 7.12 different meaning of value
                 this.ctx.beginPath();
                 this.ctx.arc(0, 0, value.size, 0, 2 * Math.PI, true);
                 this.ctx.fillStyle = `rgba(${value.color},${value.alpha})`;
                 this.ctx.fill();
                 this.ctx.setTransform(this.dpr, 0, 0, this.dpr, 0, 0);
                 // или сюда вставить requestAnimationFrame(this.animate.bind(this))?!
